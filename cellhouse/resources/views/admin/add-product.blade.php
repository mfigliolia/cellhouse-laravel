...
<head>
    ...
    <title>:: CELL.HOUSE - Agregar producto</title>
</head>
<body>
    @include('partials/admin_header')
    <h1>:: CELL.HOUSE - Agregar producto</h1>
    <h5><a href="/admin">Volver</a> - <a href="/admin/products">Ver listado de productos en la base</a></h5>
    ...
    <main class="container">
        ...
        <form class="form-group" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="categorie_id" value="{{old('categorie_id')}}" id="categorie_id" class="form-control">
            ...
            <div class="form-group">
                <input type="submit" name="enviador" value="Agregar Producto" class="btn btn-success">
            </div>
        </form>
    </main>
</body>
